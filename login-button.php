...
<?php
// Really ugly, I know. But we need that JS_DIR so pilotpress 
// can be installed in any directory structure and have these mapping resolve out
echo ".pp-lf-inner-wrapper 
{
    border-radius: 8px;
    border: 8px solid white;
    background: #fff;
    background-image: url('".JS_DIR."bg_cream_y-only.png');
    padding: 25px;
    z-index: 103;
    box-sizing: border-box;
    -moz-box-sizing: border-box;
